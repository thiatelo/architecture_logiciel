...
public class profil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MODIFIER MES INFORMATIONS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ModelsUtilisateur mu =tu.RecherchebyID(Integer.parseInt(a)); 
        
        if(mu == null){
       
            JOptionPane.showMessageDialog(null,"Utilisateur n'existe pas");
        }else{
            jTextField2.setText(mu.getPrenom());
            jTextField3.setText(mu.getNom());
            jTextField4.setText(mu.getLogin());
            pswd.setText(mu.getPassword());
